...
def parameter_details(parameter):
    ...
    if not parameter.required and has_meaningful_default:
        details.append(f"default: {json.dumps(default, separators=(',', ':'), default=str)}")
