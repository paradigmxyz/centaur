...
- Spec: `docs/superpowers/specs/2026-07-24-tako-tool-design.md`. Reference port: `workers/src/tools/_available_data.ts` and `tako_available_data.ts` in [tako-mcp](https://github.com/TakoData/tako-mcp).
