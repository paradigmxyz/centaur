...
- [x] **Step 3: Implement minimal repo-cache support**
...
- [x] **Step 5: Commit the Python slice**
...
- [x] **Step 1: Add a failing Helm render assertion script**
...
- [x] **Step 5: Commit the Helm slice**
...
- [x] **Step 2: Verify the new Rust tests fail**
...
- [x] **Step 3: Implement minimal Rust support**
...
- [x] **Step 4: Verify Rust tests and formatting**
...
- [x] **Step 5: Commit the Rust slice**
...
- [x] **Step 1: Document source and credential configuration**
...
- [x] **Step 2: Check documentation for leaks and stale GitHub-only claims**
...
- [x] **Step 1: Run focused and broad automated checks**
...
- [x] **Step 2: Prove GitHub compatibility rendering**
...
- [x] **Step 3: Prove HTTP Git behavior in kind**
