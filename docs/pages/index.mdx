...
<main className="centaur-home">
  <div className="home-bg" aria-hidden="true">
    <img className="home-bg-mark home-bg-mark-1" src="/brand/mark-outline.svg" alt="" />
    <img className="home-bg-mark home-bg-mark-2" src="/brand/mark-outline.svg" alt="" />
    <img className="home-bg-mark home-bg-mark-3" src="/brand/mark-outline.svg" alt="" />
  </div>
