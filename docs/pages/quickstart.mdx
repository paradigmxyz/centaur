...
of its answer. Stop handoff failures return a retryable response, and pending
stop intents survive service restarts. Streaming progress and titles continue
