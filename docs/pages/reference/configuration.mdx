...
repository access. DNS names do not add broad public custom-port rules. Use
repo-cache for private DNS remotes or DNS remotes on ports other than the
proxy's baseline HTTPS port.
