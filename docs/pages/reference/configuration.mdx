...
| Env var | Set from | Controls |
| --- | --- | --- |
| `CENTAUR_DEFAULT_HARNESS` | `sandbox.harnessEngine`. | Default harness for new sessions that do not explicitly request one. Existing sessions keep their pinned harness. |
