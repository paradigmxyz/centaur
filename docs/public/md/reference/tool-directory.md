...
| `datasearch` | Cited, chart-backed structured data across companies & financial markets, macroeconomics & government data, digital & industry intelligence, sports, polling & live events, and weather & climate, plus web results via Tako | None; `TAKO_API_KEY` for the full paid tier and `contents` exports |
