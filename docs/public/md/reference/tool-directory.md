...
| `datasearch` | Cited, chart-backed structured data (S&P Global financials, FRED macro, SimilarWeb traffic) plus web results via Tako | None; `TAKO_API_KEY` for the full paid tier and `contents` exports |
